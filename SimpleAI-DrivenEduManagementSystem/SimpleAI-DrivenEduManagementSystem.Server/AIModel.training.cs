...
namespace SimpleAI_DrivenEduManagementSystem_Server
{
    public partial class AIModel
    {
        public const string RetrainFilePath =  @"C:\Projects\SimpleAI-DrivenEduManagementSystem\SimpleAI-DrivenEduManagementSystem.Server\studentdata.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"HoursStudied", @"HoursStudied"),new InputOutputColumnPair(@"AttendanceRate", @"AttendanceRate")})      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"HoursStudied",@"AttendanceRate"}))      
